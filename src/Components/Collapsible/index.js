...
const Collapsible = ({ children, id, name, room, title, handleDelete }) => {
  ...
  return (
    // this is the start in the instance where the dropdown is closed
    <div className="single-ticket-container">
      <div className="ticket-body-container">
        <h3 className="ticket-info">
          <span
            className={completed ? "status-span-closed" : "status-span-open"}
          >
        ...
        >
          ...
          <div className="button-container">
            <button
              className={completed ? "reopen-button" : "complete-button"}
              onClick={() => {
